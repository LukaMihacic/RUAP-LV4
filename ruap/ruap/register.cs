...
namespace SeleniumTests
{
    ...
    public class Register
    {
        ...
        public void TheRegisterTest()
        {
            ...
            driver.FindElement(By.Id("FirstName")).SendKeys("luka04");
            driver.FindElement(By.Id("LastName")).Clear();
            driver.FindElement(By.Id("LastName")).SendKeys("luka04");
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("luka05@abc.com");
            driver.FindElement(By.Id("Password")).Clear();
            driver.FindElement(By.Id("Password")).SendKeys("444444");
            driver.FindElement(By.Id("ConfirmPassword")).Clear();
            driver.FindElement(By.Id("ConfirmPassword")).SendKeys("444444");
